          ...
          <table class="table table-striped">
            ...
            <tr>
              <td>
                ...
                <br />
                <?php
                $level = ['admin', 'Senat', 'user', 'lab', 'hdp', 'ia', 'kda', 'kndi', 'ppdp', 'ps', 'pkrpdp', 'ta', 'riset', 'bk', 'pbi', 'pbsi', 'pmat', 'pfis', 'ppkn', 'pbio', 'pgsd', 'pgpaud', 'pvto', 'pvte', 'ppg', 'mbk', 'mpmat', 'mp', 'mpbi', 'mpfis', 'mpgv'];
                foreach ($level as $s) :
                ?>
