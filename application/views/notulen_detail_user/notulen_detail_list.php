      ...
      <script type="text/javascript">
        $(document).ready(function() {
          ...
          var tabledata = $("#datatables").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "notulen_detail_user/json", "type": "POST",data:function(data){
         ...
         columns: [
         {
          "data": "id_not_detail",
          "orderable": false
        },{"data": "agenda"},{"data": "issue"},{"data": "jumlah"},{"data": "tanggal_mulai"},{"data": "tanggal_selesai"},{"data": "waktu_mulai"},{"data": "tempat"},{"data": "status","render": function (data, type, row) {
