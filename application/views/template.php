...
<body class="mini-sidebar">
                ...
                <div class="user-profile">
                    <div class="dropdown user-pro-body">
                        <div class="profile-image">
                            <img src="<?= base_url('assets/uploads/file/' . $data['foto']) ?>" alt="user-img" class="img-circle" id="image_2" onerror="this.src='<?= base_url('assets/img/no_image.jpg') ?>';">
    ...
    <script type="text/javascript">
        $(function() {
            var reload = 'yes';
            $.post('<?= base_url('notulen/get_notify') ?>', {
                reload: reload
            }, function(respond) {
