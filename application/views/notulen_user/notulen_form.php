      ...
      <div class='panel-wrapper collapse in' aria-expanded='true'>
        <div class='panel-body'>
          ...
          <form action="<?php echo $action; ?>" method="post" class='form-horizontal form-bordered' enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label for="varchar" class='control-label col-md-3'><b>Waktu Mulai<?php echo form_error('start_time') ?></b></label>
              <div class='col-md-9'>
                <input type="time" class="form-control" name="start_time" id="start_time" placeholder="Start Time" value="<?php echo $start_time; ?>" />
              </div>
            </div>
            <div class="form-group">
              <label for="varchar" class='control-label col-md-3'><b>Waktu Berakhir<?php echo form_error('end_time') ?></b></label>
              <div class='col-md-9'>
