            ...
            <div class='panel-body'>
                <form action="<?php echo $action; ?>" method="post" class='form-horizontal form-bordered'>
                    ...
                    <div class="form-group">
                        ...
                        <div class='col-md-9'>
                            <input type="text" class="form-control" name="penerima" id="PIC" placeholder="" data-role="tagsinput" value="<?php echo $penerima; ?>" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="varchar" class='control-label col-md-3'><b>Keperluan<?php echo form_error('keperluan') ?></b></label>
                        <div class='col-md-9'>
                            <textarea class="form-control" name="keperluan" id="keperluan" placeholder="" value=""><?php echo $keperluan; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class='col-md-6'>
                        <table class="table">
                          <tbody id="viewTable">
                            <tr>
                              <td colspan="2">
                                <input type="text" class="form-control" name="nama_peserta" id="participan" placeholder="" data-role="" value="<?php echo $nama_peserta; ?>" />
                              </td>
                              <td colspan="2">
                                <input type="text" class="form-control" name="instansi_peserta" id="participan" placeholder="" data-role="" value="<?php echo $instansi_peserta; ?>" />
                              </td>
                              <td colspan="2">
                                <input type="tel" class="form-control" name="no_hp_peserta" id="participan" placeholder="" data-role="" value="<?php echo $no_hp_peserta; ?>" />
                              </td>
                              <td colspan="2">
                                <input type="text" class="form-control" name="jabatan_peserta" id="participan" placeholder="" data-role="" value="<?php echo $jabatan_peserta; ?>" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
