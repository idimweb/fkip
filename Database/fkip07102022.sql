...
--
-- Host: localhost
-- Generation Time: Oct 03, 2022 at 12:18 PM
...
(15, 0, 'Kegiatan Program Studi', 'icon-list  fa-fw', 'Notulen_detail', 'Ya', 2, 'Bottom', 'admin.user'),
(13, 0, 'Daftar Program Studi', 'icon-menu  fa-fw', 'Notulen', 'Ya', 1, 'Bottom', 'admin'),
...
(24, 0, 'Asistensi', 'icon-login  fa-fw', 'Asistensi', 'Ya', 5, 'Bottom', ''),
