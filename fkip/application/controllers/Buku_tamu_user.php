...
*/
  ...
  class Buku_tamu_user extends CI_Controller
  {
    function __construct()
    {
      ...
      login_access();
      hak_akses();
      $this->load->model('Buku_tamu_user_model');
    ...
    public function index()
    {
     ...
     $this->template->load('template','buku_tamu_user/buku_tamu_list',$x);
   }

   public function json() {
    header('Content-Type: application/json');
    echo $this->Buku_tamu_user_model->json();
  }
