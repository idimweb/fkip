        ...
        <div class='panel-wrapper collapse in' aria-expanded='true'>
            <div class='panel-body'>
                <form action="<?php echo $action; ?>" method="post" class='form-horizontal form-bordered'>
                    ...
                    <!-- <div class="form-group">
                       <label for="int" class='control-label col-md-3'><b>Pengurus<?php echo form_error('id_notulen2') ?></b></label>
                       <div class='col-md-9'>
                           <input type="text" class="form-control"  id="id_notulen2" placeholder="klik disini..." />
                             <div class="nilai_notulen2"></div>
                       </div>
                   </div> -->
                   ...
                   <div class="form-group">
                        ...
                        <div class='col-md-9'>
                            <input type="file" class="form-control" name="tamu" id="tamu" placeholder="upload excel" value="" />
                        </div>
                    </div>
                    <div class="form-group">
                      <label for="varchar" class='control-label col-md-3'><b>Lainya<?php echo form_error('lainya') ?></b></label>
                      <div class='col-md-6'>
                        <table class="table">
                          <tbody id="viewTable">
                            <tr>
                              <td colspan="2">
                                <input type="text" class="form-control" name="lainya" id="lainya" placeholder="Ketik nama" data-role="" value="" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                    ...
                    <div class="form-group">
                      ...
                      <div class='col-md-3'>
                        <input type="time" class="form-control" name="waktu_mulai" id="waktu_mulai" placeholder="" value="" />
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="varchar" class='control-label col-md-3'><b>Waktu Berakhir<?php echo form_error('waktu_selesai') ?></b></label>
                      <div class='col-md-3'>
                        <input type="time" class="form-control" name="waktu_selesai" id="waktu_selesai" placeholder="" value="" />
                      </div>
                    </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class='col-md-3'>
                          <input type="radio" id="tempat" name="lokasi" onclick="lok()" value="Daring"> Daring<br>
                        </div>
                        <div class='col-md-3'>
                          <input type="radio"  id="tempat"name="lokasi" onclick="lok()" value="Majelis Dikti"> Luring<br>
                        </div>
                        <div class='col-md-3'>
                          <input type="text" class="form-control" name="tempat" id="tempat" value="" placeholder="Tempat" />
                        </div>
                      </div>
                    ...
                    <div class="form-group">
                      <label for="varchar" class='control-label col-md-3'><b>Notulen<?php echo form_error('catatan') ?></b></label>
                      <div class='col-md-9'>
                        <input type="file" class="form-control" name="note" id="note" placeholder="Absensi" value="" />
                      </div>
                    </div>
                            ...
                            <div class='col-md-12'>
                                <div class='row'>
                                    <div class='col-md-offset-3 col-md-9'>
                                     <button type="submit" name="submit" class="btn btn-info"><i class='fa fa-check'></i><?php echo $button ?></button>
  ...
  $(function(){
    <?php if($this->uri->segment(2) == 'edit'): ?>
      ...
      $.ajax({
        ...
        dataType:'json',
        success:function(data){
        $('.nilai_notulen2').html('<hr /><input type="hidden" name="data_notulen" value="'+data.id_anggota+'"><input type="text" class="form-control" value="'+data.jabatan+'" readonly>');
        },error:function(data){
         swal('error','server not response','error');
        }
      });
    <?php else: ?>
    $('.nilai_notulen2').html('<div class="alert alert-danger">Peserta..</div>');
    <?php endif; ?>
    $('#id_notulen2').click(function(){
     $('#modal_not2').modal('show');
    });
  });
</script>
  ...
  $(function(){
    <?php if($this->uri->segment(2) == 'edit'): ?>
      ...
      $.ajax({
        ...
        dataType:'json',
        success:function(data){
        $('.nilai_notulen3').html('<hr /><input type="hidden" name="data_notulen" value="'+data.id_asistensi+'"><input type="text" class="form-control" value="'+data.bidang+'" readonly>');
        },error:function(data){
         swal('error','server not response','error');
        }
      });
    <?php else: ?>
    $('.nilai_notulen3').html('<div class="alert alert-danger">Asistensi..</div>');
    <?php endif; ?>
    $('#id_notulen3').click(function(){
     $('#modal_not3').modal('show');
    });
  });
</script>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var t = $("#datatables2").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "<?= base_url('anggota/json_checkbox') ?>", "type": "POST"},
            columns: [
            {
                "data": "id_anggota",
                "orderable": false
...
/*pilih peserta*/
   function pilih_peserta(n){
     $.ajax({
        ...
        dataType:'json',
        success:function(data){
          $('.nilai_notulen2').html('<hr /><input type="hidden" name="id_notulen2" value="'+data.id_notulen+'"><input type="text" class="form-control" value="'+data.nama_agenda+'" readonly>');
          $('#modal_not2').modal('hide');
        },error:function(data){
            swal('error','Data tidak respons','error');
        }
     })
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var t = $("#datatables3").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "<?= base_url('asistensi/json_checkbox') ?>", "type": "POST"},
            columns: [
            {
                "data": "id_asistensi",
                "orderable": false
            },{"data": "nama_asistensi"},{"data": "bidang"},
            {
                "data" : "action",
                "orderable": false,
                "className" : "text-center"
...
<script>
  $(document).ready(function() {
    $("#openTable").click(function() {
      $("#viewTable").append("<tr><td colspan='2'><input type='text' class='form-control' name='peserta' id='participan' placeholder='Ketik nama' data-role='' value='' /> \
