				  <?php $yahoo = mysqli_query($koneksi, "SELECT * FROM mod_ym");  
						$hitung = mysqli_num_rows($yahoo); 
						if ($hitung <= 0){
						}else{ ?>
							<div class="widget">
								<h3>Online Support (Chat)</h3>
								<?php while ($ym = mysqli_fetch_array($yahoo)){ ?>
						...
						<?php } ?>
							...
							<div class="widget">
								...
								<div class="widget-articles">
									<ul>
										<li>
											<?php 
												$populer = mysqli_query($koneksi, "SELECT * FROM berita 
												...
												while ($r2x = mysqli_fetch_array($populer)){
							...
							<div class="widget">
								...
								<div class="widget-comments">
									<ul>
										<?php
											$komentar = mysqli_query($koneksi, "SELECT * FROM komentar where aktif='Y' order by id_komentar DESC LIMIT 3");
							...
							<div class="widget">
								...
								<div class="latest-galleries">
									<?php
									  ...
									  $terkini2=mysqli_query($koneksi, "select * from video ORDER BY id_video DESC LIMIT 2"); 				   
